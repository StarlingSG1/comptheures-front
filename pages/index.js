    ...
    <>
      <MobileTemplate>
        ...
        <div className="w-full flex flex-col items-center gap-20">
          ...
          <Button onClick={() => { setHomeOpen(true) }}>Commencer à compter</Button>
        </div>
        <div className={`fixed bottom-0 left-0 w-full px-[30px] py-8 dark:bg-blue-dark bg-blue h-1/2  rounded-t-[32px] duration-200 flex flex-col justify-between  ${homeOpen ? "" : "translate-y-full "}`}>
